...
compare_dicts(Session_level_all_cmps['func1'],Session_level_all_cmps['func2'])
diff12_df=Session_level_all_cmps['func1']['TD vs df_feature_lowMinimal_CSS >> LOCDEP_Proximity_cols::ASDTD'].X -\
 Session_level_all_cmps['func2']['TD vs df_feature_lowMinimal_CSS >> LOCDEP_Proximity_cols::ASDTD'].X