...
def get_args():
    ...
    parser.add_argument('--filepath', default='/homes/ssd1/jackchen/DisVoice/data/Segments_info_2ndpass_doc',
                        help='path of the base directory')
    parser.add_argument('--trnpath', default='/mnt/sdd/jackchen/egs/formosa/s6/Alignment_ADOShappyDAAIKidallDeceiptformosaCSRC_chain_2ndPass_SingleWord/doc/ADOS_tdnn_fold_transfer_word',
                        help='path of the base directory')
...
def Get_phonationdictbag_map(files, Info_name_sex, Namecode_dict):
    ...
    # outpath= PhonationPath + "/features/multijobs/"
