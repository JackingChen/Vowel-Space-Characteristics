...
def prefine_GlobalVariables(df_formant_statistic_77):
    ...
    filter_Notautism=df_formant_statistic_TD['ADOS_cate']==0
    filter_ASD=df_formant_statistic_TD['ADOS_cate']==1
    filter_Autism=df_formant_statistic_TD['ADOS_cate']==2
...
def Analysis_NormWCC_distribOfDocKID(df_person_segment_feature_dict_ASD_formant,\
                                     feat_getter,feat='within_covariance_norm(A:,i:,u:)'):
    # =============================================================================
    '''
