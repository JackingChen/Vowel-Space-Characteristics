...
def get_args():
    ...
    parser.add_argument('--check', default=True, type=bool,
                            help='')
    parser.add_argument('--skipwarning', default=True,
                        help='')
    ...
    parser.add_argument('--MinPhoneNum', default=3,
                            help='path of the base directory')
    parser.add_argument('--timeseriesLen', default=2,
                            help='path of the base directory')
...
pickle.dump(Formants_people_segment_DKIndividual_utt_dict,open(outpklpath+"Formants_people_segment_DKIndividual_utt_dict_{0}_{1}.pkl".format(dataset_role,args.suffix),"wb"))
pickle.dump(Formants_people_segment_DKcriteria_utt_dict,open(outpklpath+"Formants_people_segment_DKcriterial_utt_dict{0}_{1}.pkl".format(dataset_role,args.suffix),"wb"))
...
#%%
Formants_people_segment_DKIndividual_utt_dict=pickle.load(open(outpklpath+"Formants_people_segment_DKIndividual_utt_dict_{0}_{1}.pkl".format(dataset_role,args.suffix),"rb"))
Formants_people_segment_DKcriterial_utt_dict=pickle.load(open(outpklpath+"Formants_people_segment_DKcriterial_utt_dict{0}_{1}.pkl".format(dataset_role,args.suffix),"rb"))
...
pickle.dump(df_person_segment_feature_DKIndividual_dict,open(outpklpath+"df_person_segment_feature_DKIndividual_dict_{0}_{1}_{2}.pkl".format(dataset_role, 'formant',args.suffix),"wb"))
pickle.dump(df_person_segment_feature_DKcriteria_dict,open(outpklpath+"df_person_segment_feature_DKcriteria_dict_{0}_{1}_{2}.pkl".format(dataset_role, 'formant',args.suffix),"wb"))
...
for dataset_role in ['ASD_DOCKID','TD_DOCKID']:
    ...
    if Reorder_type == 'DKIndividual':
        df_person_segment_feature_DKIndividual_dict=pickle.load(open(outpklpath+"df_person_segment_feature_{Reorder_type}_dict_{0}_{1}_{2}.pkl".format(dataset_role, 'formant',args.suffix,Reorder_type=Reorder_type),"rb"))
    elif Reorder_type == 'DKcriteria':
        df_person_segment_feature_DKcriteria_dict=pickle.load(open(outpklpath+"df_person_segment_feature_{Reorder_type}_dict_{0}_{1}_{2}.pkl".format(dataset_role, 'formant',args.suffix,Reorder_type=Reorder_type),"rb"))
    ...
    Picklepath=outpklpath+"Syncrony_measure_of_variance_{Reorder_type}_{0}_{1}.pkl".format(dataset_role,args.suffix,Reorder_type=Reorder_type)
    Picklepath_Features=outFeatpath+"Syncrony_measure_of_variance_{Reorder_type}_{0}_{1}.pkl".format(dataset_role,args.suffix,Reorder_type=Reorder_type)
    print("Features generated at ", outFeatpath+"Syncrony_measure_of_variance_{Reorder_type}_{0}_{1}.pkl".format(dataset_role,args.suffix,Reorder_type=Reorder_type))
