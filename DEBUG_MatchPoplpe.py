...
if args.Mergefeatures:
    ...
    for dataset_role in ['ASD_DOCKID','TD_DOCKID']:
        ...
        if args.ADDUtt_feature==True:
            merge_out_path='Features_BeforeTASLPreview120230607/ClassificationMerged_dfs/ADDed_UttFeat/{knn_weights}_{knn_neighbors}_{Reorder_type}/{dataset_role}/'.format(knn_weights=knn_weights,knn_neighbors=knn_neighbors,dataset_role=dataset_role,Reorder_type=Reorder_type)
        else:
            merge_out_path='Features_BeforeTASLPreview120230607/ClassificationMerged_dfs/{knn_weights}_{knn_neighbors}_{Reorder_type}/{dataset_role}/'.format(knn_weights=knn_weights,knn_neighbors=knn_neighbors,dataset_role=dataset_role,Reorder_type=Reorder_type)
...
tolarence=1e-5
diff12_df=Session_level_all_old['TD vs df_feature_lowMinimal_CSS >> LOCDEP_Proximity_cols::ASDTD'].X -\
 Session_level_all_new['TD vs df_feature_lowMinimal_CSS >> LOCDEP_Proximity_cols::ASDTD'].X
