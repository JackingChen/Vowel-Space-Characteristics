...
def get_args():
    ...
    parser.add_argument('--filepath', default='/media/jack/workspace/DisVoice/data/Segmented_ADOS_emotion_normalized',
                        help='/media/jack/workspace/DisVoice/data/{Segmented_ADOS_normalized|Session_ADOS_normalized}')
    ...
    parser.add_argument('--outpath', default='/media/jack/workspace/DisVoice/articulation/Pickles',
                        help='path of the base directory')
