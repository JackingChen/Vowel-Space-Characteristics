...
Place_sets['velar']=Phoneme_sets['k'] + Phoneme_sets['k_h'] + Phoneme_sets['n'] + Phoneme_sets['x'] + Phoneme_sets['w']
...
Place_sets['rounded']=Phoneme_sets['w'] + Phoneme_sets['H']
...
Place_sets_simple1['alveolar']=Phoneme_sets['t'] + Phoneme_sets['t_h'] + Phoneme_sets['n'] + \
                            Phoneme_sets['ts'] + Phoneme_sets['ts_h'] + Phoneme_sets['s'] + Phoneme_sets['l']
Place_sets_simple1['velar']=Phoneme_sets['k'] + Phoneme_sets['k_h'] + Phoneme_sets['n'] + Phoneme_sets['x'] + Phoneme_sets['w']
...
Place_sets_simple1['rounded']=Phoneme_sets['w'] + Phoneme_sets['H']
...
Place_sets_simple2['labial']=Phoneme_sets['p'] + Phoneme_sets['p_h'] + Phoneme_sets['m'] +\
                             Phoneme_sets['f'] + Phoneme_sets['w'] + Phoneme_sets['H']
...
Place_sets_simple2['dorsal']=Phoneme_sets['k'] + Phoneme_sets['k_h'] + Phoneme_sets['n'] + Phoneme_sets['x'] + Phoneme_sets['w'] +\
...
Manner_sets['glide'] = Phoneme_sets['w'] + Phoneme_sets['j'] + Phoneme_sets['y']
...
Manner_sets_simple1['glide'] = Phoneme_sets['j'] + Phoneme_sets['w'] + Phoneme_sets['y']
...
Manner_sets_simple2['glide'] = Phoneme_sets['w'] + Phoneme_sets['j'] + Phoneme_sets['y']
