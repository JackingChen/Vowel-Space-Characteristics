...
limit_people_rule=GetValuelimit_IQR(AUI_info,PhoneMapp_dict,Inspect_features)
...
VUIsource="From__Formant_people_information"
if VUIsource=="From__Formants_people_symb":
    Vowels_AUI=Dict()
            ...
            if phone not in [e for _, phoneme in PhoneMapp_dict.items() for e in phoneme]: # update fixed 2021/05/27
                ...
                if people not in Vowels_AUI.keys():
                    ...
                    if Phone_represent not in Vowels_AUI[people].keys():
                        ...
                        Vowels_AUI[people][Phone_represent].extend(values)
elif VUIsource=="From__Formant_people_information":
    Vowels_AUI=Dict()
    for people in AUI_info.keys():
...
df_formant_statistic=articulation.calculate_features(Vowels_AUI,Label)
